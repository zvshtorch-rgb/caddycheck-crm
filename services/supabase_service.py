...
def load_projects() -> list:
    ...
    for row in _select_all_rows("projects", order_column="project_name"):
        ...
        p = Project(
            ...
            backtray_cameras=row.get("backtray_cameras") or 0,
            topdown_cameras=row.get("topdown_cameras") or 0,
            pushout_cameras=row.get("pushout_cameras") or 0,
            sco_cameras=row.get("sco_cameras") or 0,
